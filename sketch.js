...
function preload() {
  ...
  sadZombie = loadImage("./assets/sadzombieimg.png");

  sadZombie.playing = true;
  sadZombie.looping = false;
...
function setup() {
  ...
  zombie.scale = 0.1;
  zombie.velocityX = 10;
  zombie.addAnimation("sadness", sadZombie);
...
function draw() {
  ...
  if (collide(stones, zombie)===true) 
  {
    zombie.changeAnimation('sadness');
  }
